export default function NewSignin(){
    return(
    <section class="h-screen  flex flex-column justify-center items-center">
    <div class="h-full flex flex-column justify-center items-center ">
   
    <div
      class="g-6 flex h-4/5 flex-wrap items-center justify-center lg:justify-between bg-custom-blue rounded-lg">
      <div
